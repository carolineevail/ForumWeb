...
public class MainTest {
    ...
    public void testMessage() throws SQLException {
        ...
        Main.insertUser(conn, "Alice", "");
        User user = Main.selectUser(conn, "Alice");
        Main.inserMessage(conn, user.id, -1, "Hello, world!");
    ...
    public void testReplies() throws SQLException {
        ...
        Main.inserMessage(conn, alice.id, -1, "Hello, world!");
        Main.inserMessage(conn, bob.id, 1, "This is a reply!");
        Main.inserMessage(conn, bob.id, 1, "This is another reply!");
